...
export const PAINTS = [
  ...
  { name: 'Cadmium Yellow Light',       rgb: [253, 219, 1  ] },
  { name: 'Cadmium Red',                rgb: [229, 0,   27 ] },
  { name: 'Alizarin Crimson Permanent', rgb: [140, 16,  36 ] },
  { name: 'Ultramarine Blue',           rgb: [18,  10,  143] },
  { name: 'Phthalo Blue (Green Shade)', rgb: [0,   43,  93 ] },
]
